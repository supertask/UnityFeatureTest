...
{
    [UnityEngine.AddComponentMenu("Klak/Procedural Motion/Brownian Motion Extra")]
    public sealed class BrownianMotionExtra : UnityEngine.MonoBehaviour
    {
        ...
        public void Rehash()
        {
            ...
            _positionOffset = new float3(0);
            _rotationOffset = new float3(0);
