...
namespace PrefsGUI.Kvs
{
    ...
    /// </summary>
    public class PrefsKvsStreamingAssetsPath : MonoBehaviour, IPrefsKvsPath
    {
        #region Type Define
...
")]
        ...
        protected string _path = "Rosetta";
        
        public string path => IsPlatformActive(platform)
                ? pathWithoutPlatformCheck
                : null;

        public string pathWithoutPlatformCheck => ReplaceMagicWord(Path.Combine(Application.streamingAssetsPath, _path));
    }
}